...
const ALL_CATEGORIES: (ContentCategory | 'all')[] = [
    'all',
    'application',
    'audio',
    'font',
...
export default function ReferenceTab({}: TabComponentProps) {
    ...
    const handleToggleExpand = useCallback((ct: string) => {
    ...
    return (
        <ToolTabWrapper>
            <div className="flex flex-col gap-4 py-4">
                <div className="flex flex-col gap-3 md:flex-row md:items-start">
                    <div className="relative flex-1">
                        ...
                        <Input
                            ...
                            placeholder="Search by Content-Type, extension, or description..."
                ...
                <NpmPackageCard
                    packageName="content-types-lite"
                    href="https://www.npmjs.com/package/content-types-lite"
                />
                    ...
                    <div className="flex flex-col gap-0.5">
                        ...
                        <div className="flex flex-col">
                            {filtered.map((entry) => {
                                ...
                                const isExpanded = expanded === entry.contentType;
                                return (
                                    <div key={entry.contentType} className="contents">
                                        <button
                                            onClick={() => handleToggleExpand(entry.contentType)}
                                        ...
                                        >
                                            ...
                                            <span className="flex justify-end">
                                                <Button
                                                    ...
                                                    onClick={(e) => {
                                                        e.stopPropagation();
                                                        handleCopy(entry.contentType);
                                                    }}
                                                >
                                                    {copied === entry.contentType ? (
