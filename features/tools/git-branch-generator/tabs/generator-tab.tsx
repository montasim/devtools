...
export default function GeneratorTab({ readOnly }: TabComponentProps) {
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {ISSUE_TYPES.map((type) => {
                            ...
                            return (
                                <button
                                    key={type.value}
                                    onClick={() => !readOnly && setIssueType(type.value)}
                                    disabled={readOnly}
                ...
                <div>
                    ...
                    <Input
                        ...
                        type="text"
                        value={issueId}
                        onChange={(e) => !readOnly && setIssueId(e.target.value)}
                ...
                <div>
                    ...
                    <Input
                        ...
                        disabled={readOnly}
                        onKeyDown={(e) => {
                            if (e.key === 'Enter' && !readOnly) generateBranchName();
                        }}
                    />
                    <p className="mt-1 text-xs text-muted-foreground">
