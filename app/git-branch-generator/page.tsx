            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
                ...
                <div className="mx-auto py-4">
                    <div className="mx-auto">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Support for feature, bug fix, hotfix, refactor, docs,
                                            test, chore, performance, style, and CI/CD branches
                                        </p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Optional issue ID field for JIRA, GitHub Issues, or any
                                            ticket system
                                        </p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Choose between dash (-) or underscore (_) for word
                                            separators
                                        </p>
                                    </div>
                                </div>
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            One-click copy to clipboard for quick use in your
                                            terminal
                                        </p>
                                    </div>
                                </div>
                            ...
                            <ol className="space-y-4">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Choose the type of work you&apos;re doing (feature, bug
                                            fix, hotfix, etc.) or select &quot;None&quot; for a
                                            simple branch name
                                        </p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-gray-900 dark:text-gray-100">
                                            Add Issue ID (Optional)
                                        </h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Enter your ticket number from JIRA, GitHub Issues, or
                                ...
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Select dash (-) or underscore (_) as the separator
                                            between words in your description
                                        </p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Type a brief description of your changes. The generator
                                            will format it automatically
                                        </p>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Click &quot;Generate Branch Name&quot; or press Enter,
                                            then copy the result to use in your Git workflow
                                        </p>
                                    </div>
                                </li>
                            </ol>
                        ...
                        <div className="mt-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl border border-blue-200 dark:border-blue-800 p-6">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center gap-2">
                            ...
                            <div className="space-y-3 text-sm">
                                <div className="flex gap-2">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300">
                                        ...
                                        Issue types help categorize branches and make it easy to
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300">
                                        ...
                                        Linking branches to tickets improves traceability and makes
                                        it easier to find related work
                                    </p>
                                </div>
                                <div className="flex gap-2">
                                    <ArrowRight className="w-4 h-4 text-blue-500 shrink-0 mt-0.5" />
                                    <p className="text-gray-700 dark:text-gray-300">
                                        ...
                                        Use short, descriptive names that clearly explain what the
                                        branch does
                                    </p>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300">
                                        <strong className="text-gray-900 dark:text-gray-100">
                                            Use lowercase and hyphens/underscores:
                                        </strong>{' '}
                                        This avoids issues with case-sensitive file systems and
                                        keeps branch names readable
                                    </p>
                                </div>
                                <div className="flex gap-2">
                                    <ArrowRight className="w-4 h-4 text-blue-500 shrink-0 mt-0.5" />
                                    <p className="text-gray-700 dark:text-gray-300">
                                        ...
                                        Stick to alphanumeric characters, hyphens, underscores, and
                                        forward slashes to ensure compatibility
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* SEO Content Section */}
                        <article className="mt-6 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">
                                Why Use a Git Branch Name Generator?
                            </h2>
                            <div className="prose prose-sm dark:prose-invert max-w-none">
                                <p className="text-gray-700 dark:text-gray-300 mb-4">
                                    Consistent branch naming is crucial for maintaining an organized
                                    and professional Git workflow. A well-structured branch naming
                                    convention helps teams collaborate more effectively, makes code
                                    reviews easier, and improves the overall development experience.
                                </p>
                                <p className="text-gray-700 dark:text-gray-300 mb-4">
                                    This Git Branch Name Generator automates the process of creating
                                    properly formatted branch names according to industry best
                                    practices. Whether you&apos;re following GitFlow, GitHub Flow,
                                    or your own custom workflow, this tool ensures your branches are
                                    named consistently every time.
                                </p>
                                ...
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                                    <li>
                                        <strong>Improved collaboration:</strong> Team members can
                                        quickly understand what each branch is working on
                                    </li>
                                    <li>
                                        <strong>Better organization:</strong> Easily filter and sort
                                        branches by type or issue ID
                                    </li>
                                    <li>
                                        <strong>Enhanced traceability:</strong> Link branches to
                                        issues and track work from ticket to deployment
                                    </li>
                                    <li>
                                        <strong>Automated integration:</strong> Works seamlessly
                                        with CI/CD pipelines and deployment tools
                                    </li>
                                    <li>
                                        <strong>Professional workflow:</strong> Maintain clean,
                                        readable branch names across all your projects
                                    </li>
                                </ul>
                            </div>
                        </article>
