    ...
    return (
        <div className="space-y-3">
            {shortcuts.map((shortcut, index) => (
                <div
                    key={index}
                    className="flex items-center justify-between group/item hover:bg-white/50 dark:hover:bg-black/20 rounded-lg px-3 py-2 -mx-3 transition-colors"
                >
...
function ShortcutCard({
    ...
    return (
        <div
            className={`group relative overflow-hidden rounded-2xl ${gradientClass} ${borderClass} p-6 transition-all duration-300 hover:shadow-xl hover:scale-[1.02]`}
        >
            <div
                className={`absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl group-hover:bg-opacity-20 transition-all duration-500`}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    Use{' '}
                                    <kbd className="px-1.5 py-0.5 text-xs font-semibold rounded bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600">
                                        ⌘
                                    </kbd>{' '}
                                    on Mac or{' '}
                                    <kbd className="px-1.5 py-0.5 text-xs font-semibold rounded bg-gray-200 dark:bg-gray-700 border border-gray-300 dark:border-gray-600">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>
                                    ...
                                    with export shortcuts for different formats
                                </span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-amber-500 mt-0.5">•</span>
