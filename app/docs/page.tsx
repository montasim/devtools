                        ...
                        <section id="overview" className="scroll-mt-32">
                            <div className="mb-6">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                    The JSON Diff Tool is a powerful utility for comparing and
                                    analyzing differences between JSON documents. It provides
                                    multiple comparison modes, export options, and advanced features
                                    to help you understand and communicate changes in your data.
                                </p>
                            </div>
                        ...
                        <section id="features" className="scroll-mt-32">
                            ...
                            <div className="space-y-4">
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Choose between unified, split, inline, and tree views to
                                        visualize changes in the way that works best for you.
                                    </p>
                                </div>
                                ...
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Export diffs in multiple formats including JSON Patch, Merge
                                        Patch, downloadable files, and HTML reports.
                                    </p>
                                </div>
                                ...
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Power user keyboard shortcuts for quick filtering,
                                        exporting, and panel toggling.
                                    </p>
                                </div>
                        ...
                        <section id="configuration" className="scroll-mt-32">
                            ...
                            <div className="space-y-4">
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        When enabled, the comparison ignores the order of keys in
                                        JSON objects. This is useful when comparing JSON generated
                                        by different serializers that may produce equivalent data
                                ...
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Automatically formats JSON output with proper indentation
                                        and line breaks for better readability in the diff display.
                                    </p>
                                </div>
                                ...
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        When enabled, whitespace differences are ignored during
                                        comparison. Useful when comparing JSON that differs only in
                                ...
                                <div className="p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Performs intelligent type-aware comparisons that understand
                                        data types and structures, detecting semantic changes beyond
                                        simple text differences.
                                    </p>
                                </div>
                            </div>
                        </section>
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-4 p-5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Paste or type your JSON content into the left and right
                                            editor panels. The editors support syntax highlighting
                                ...
                                <div className="flex gap-4 p-5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Toggle the comparison options at the top to customize
                                            how the diff is computed based on your needs.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 p-5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Click the &ldquo;Compare&rdquo; button to generate the
                                            diff. Results appear below, showing additions,
                                ...
                                <div className="flex gap-4 p-5 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-gray-400">
                                            Use filter options to focus on specific change types.
                                            Export the diff in various formats or use keyboard
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="p-5 rounded-xl bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 border border-purple-200 dark:border-purple-800">
                                    ...
                                    <p className="text-sm text-purple-700/70 dark:text-purple-300/70 mb-2">
                                        Toggle tree structure, statistics, validation, and bookmarks
                                        panels
                                    </p>
                                </div>
                                ...
                                <div className="p-5 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border border-orange-200 dark:border-orange-800">
                                    ...
                                    <p className="text-sm text-orange-700/70 dark:text-orange-300/70 mb-2">
                                        Automatic dark mode support for comfortable viewing in any
                                        lighting
                                    </p>
                                </div>
                            </div>
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-sm text-amber-900 dark:text-amber-100">
                                            Use <strong>Ignore Key Order</strong> when comparing
                                            JSON from different sources with different serialization
                                            approaches
                                        </span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                    ...
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span className="text-sm text-amber-900 dark:text-amber-100">
                                            Use <strong>bookmarks</strong> to mark important hunks
