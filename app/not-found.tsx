      ...
      <div className="rounded-lg bg-muted p-4 text-left font-mono text-sm sm:text-base">
        <div className="space-y-1">
          <p className="text-muted-foreground">
            <span className="text-primary">$</span> curl https://devtools.com/invalid-endpoint
          </p>
          ...
          <p className="text-muted-foreground pl-4">
            ...
            <span className="text-green-500">"ROUTE_NOT_FOUND"</span>,
          </p>
          <p className="text-muted-foreground pl-4">
            <span className="text-foreground">"message":</span>{" "}
            <span className="text-green-500">"The requested endpoint is not registered"</span>,
          </p>
          <p className="text-muted-foreground pl-4">
            <span className="text-foreground">"availableEndpoints":</span>{" "}
            <span className="text-primary">["/", "/text", "/xml", "/csv"]</span>
          </p>
